...
struct ListItemView_Previews: PreviewProvider {
    static var viewModel = ListItemViewModel(freak: Freak(imageName: "test1", firstName: "Vlad", lastName: "Stanescu", description: "Lorem ipsum", skills: [Skill(id: 0, name: "Proj management")], projects: [Project(id: 0, name: "Epix", description: "Streaming service")], technologies: [Technology(id: 0, name: "iOS", description: "test")], role: "iOS Developer", level: "Senior", norm: "Fulltime", id: 0))
