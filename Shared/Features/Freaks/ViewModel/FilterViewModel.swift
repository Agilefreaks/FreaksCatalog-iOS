...
class FilterViewModel: ObservableObject {
    ...
    var projects: [Project] = [Project(id: 1, name: "FreaksCatalog", description: "Catalog of freaks", technologies: [Technology(id: 0, name: "test", description: "test")]), Project(id: 0, name: "EPIX", description: "Lorem Ipsum", technologies: [Technology(id: 0, name: "test", description: "test")]), Project(id: 2, name: "reAsig", description: "Lorem Ipsum", technologies: [Technology(id: 0, name: "test", description: "test")]), Project(id: 3, name: "UNGC", description: "Lorem ipsum", technologies: [Technology(id: 0, name: "test", description: "test")])].sorted(by: { $0.name.lowercased() < $1.name.lowercased() })
